...
""".strip()
    ...
    def ask(self, query):
        ...
        if not results:
            return {
                "answer": "No relevant document information found.",
                "sources": []
            }
        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "After your answer, write USED_SOURCES: followed only "
                    "by the SOURCE_ID values that directly support your answer. "
        ...
        if "USED_SOURCES:" in raw_answer:
            answer_part, source_part = raw_answer.split(
                "USED_SOURCES:",
                1
            )
        ...
        for source_id in used_source_ids:
            ...
            metadata = results[source_index]["metadata"]
